...
// CobraBytes: total coins staked (non-spendable until maturity)
...
// CobraBytes: get current stake weight
...
// CobraBytes: check 'spent' consistency between wallet and txindex
// CobraBytes: fix wallet spent state according to txindex
...
// CobraBytes: disable transaction (only for coinstake)
